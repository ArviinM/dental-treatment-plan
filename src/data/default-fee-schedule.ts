...
export const FEE_SCHEDULE_VERSION = '2025.12.18.v3';
...
export const defaultFeeSchedule: FeeItem[] = [
  ...
  {
    code: '012',
    name: "Periodic Oral Examination",
  ...
  {
    code: '072',
    name: "Photographic Records - Intraoral - per appointment",
    description: "We’ll take close-up photos inside your mouth to track your progress and treatment results.",
    fee: 45.0,
  },
  {
    code: '073',
    name: "Photographic Records - Extraoral - per appointment",
  ...
  {
    code: '415',
    name: "Complete chemo-mechanical preparation of root canal -",
  ...
  {
    code: '2',
    name: "Late Cancellation / Fta Fee",
